    ...
    <body class="bg-info d-flex justify-content-center align-items-center vh-100">
        <div
            ...
            <div class="d-grid gap-2 mt-2">
                <button type="submit" class="btn btn-primary btn-lg " onclick="botonlogin()"  >
                    login
                </button>
            </div>
            <div>
                <style>
                    body{
                        background-image:url(imagen/campus-Lima-1.png);
        ...
        <script src="recursos/js/botonlogin.js"></script>
    </body>
</html>